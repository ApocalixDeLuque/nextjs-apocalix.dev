...
const Menu = () => {
    ...
    return (
        <nav className="flex flex-col gap-2 lg:hidden">
            ...
            <Link scroll={false} href={`#${getText('projects', 'proyectos')}`}>
                <p className="hover:text-red transition-all duration-[250ms]">
                    {getText('projects', 'proyectos')}
                </p>
            </Link>
            <Link scroll={false} href={`#${getText('about-me', 'sobre-mi')}`}>
                <p className="hover:text-red transition-all duration-[250ms]">
                    {getText('about me', 'sobre mí')}
                </p>
            </Link>
            <Link scroll={false} href={`#${getText('contact', 'contacto')}`}>
                <p className="hover:text-red transition-all duration-[250ms]">
                        ...
                        <div className="absolute rounded-[16px] 3xl:text-3xl top-[68px] sm:top-[80px] right-1 xs:right-[12px] sm:right-[52px] xl:right-[104px] flex flex-col text-center gap-3 bg-light p-3 border border-lightgray select-none">
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <p className="xl:text-dark text-gray flex group-hover:text-light transition-all duration-[250ms]">
                                        {getText('english', 'español')}
                                    </p>
                                </div>
                            </CustomTooltip>
