...
const Hero = () => {
    ...
    return (
        <section
            id={`${getText('home', 'inicio')}`}
            className="flex min-h-screen w-full justify-center items-center border-b-2 border-lightgray bg-[url('/hero-pattern.png')] bg-center py-8 md:py-16 px-8 sm:p-16 xl:py-40 xl:px-32"
        >
